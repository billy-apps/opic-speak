...
export const SCRIPTS: Script[] = [
  ...
  },
  {
    ...
    al: {
      ...
      p: ["technology should feel genuinely human and accessible", "the courage to say no. to complexity, to features that don't truly serve anyone", "decisions that shape how millions of people interact with technology"],
    },
  },
  {
  ...
  // ─────────────────────────────────────────────
  {
    ...
    ih: {
      t: "One of my favorite hobbies these days is {hobby|playing the piano}. I had some lessons as a child but stopped for years, and then about {period|two years} ago I started practicing again on my own. I practice most evenings for about {time|thirty to forty minutes} after work. What I love most is {reason|how it pulls me completely into the present. you can't be thinking about your to-do list when you're working through a passage that demands your full concentration}. There's also something deeply satisfying about {feel|the way a piece that once seemed impossibly difficult gradually becomes something you can actually play}. It's become one of the most reliable ways I have to genuinely decompress at the end of the day.",
      p: ["pulls me completely into the present", "impossibly difficult passages gradually becoming something you can play", "the most reliable way to genuinely decompress at the end of the day"],
    },
    al: {
      t: "The hobby I'm most passionate about right now is {hobby|playing the guitar}. I've been at it seriously for about {period|four years} now, and my relationship with the instrument has changed considerably over that time. What started as a way to {reason1|learn a few songs and impress people at parties} has evolved into something far more personal. {insight|I now practice not to perform but to explore. to figure out what I actually want to say through the instrument}. What I find most absorbing about it is {aspect|the gap between hearing something in your head and being able to produce it with your hands}. Closing that gap requires a kind of patient, deliberate practice that I find nowhere else. It's also taught me more than I expected about {lesson|how to sit with frustration and keep returning to something difficult without the expectation of quick results}. Music has become less a hobby and more {metaphor|a practice in learning how to learn}.",
      p: ["practicing not to perform but to explore", "the gap between hearing it in your head and producing it with your hands", "a practice in learning how to learn"],
    },
  },
  {
    id: 'hobby_climb', collectionId: '취미 활동', em: '🧗', nm: '클라이밍',
    tc: '#B87A1A', tb: 'rgba(184,122,26,0.10)',
    qs: ['How long have you been into climbing?', 'Have you tried outdoor climbing?', 'What do you find most challenging about climbing?'],
    im: {
  ...
  },
  {
    ...
    qs: ['How did you get into photography?', 'Do you prefer digital or film photography?', 'What kind of photos do you like to take?'],
    im: {
    ...
    al: {
      t: "The hobby I'm most passionate about is {hobby|film photography}. I came to it gradually. {trigger|I'd been shooting digitally for a couple of years and started to feel like I was taking too many pictures and really looking at almost none of them}. A friend suggested I try a roll of film just to slow down, and something about the experience immediately clicked. What draws me to film specifically is {reason|the enforced pause before each shot. you can't review and delete instantly, so you have to commit. and that commitment changes how you see}. Over time, it's become less about producing images and more about {insight|training a different quality of attention. the kind that notices things before reaching for the camera, rather than using the camera as an excuse to look}. I've also become deeply interested in {aspect|the darkroom process}. watching an image emerge in developer is one of the few genuinely slow and tactile experiences left in my otherwise very digital life. It's taught me that {lesson|some things are worth doing the slow way, not despite the inefficiency but because of it}.",
      p: ["commitment changes how you see", "training attention that notices before reaching for the camera", "worth doing the slow way. not despite the inefficiency but because of it"],
    },
  },
  {
  ...
  },
  {
    ...
    al: {
      t: "I've been running seriously for {years|about five years}, and my relationship with it has transformed considerably. It started as a way to stay fit, but it's become something far more fundamental. {reframe|one of the few activities that clears my head completely, and one I structure my entire week around}. The turning point was {trigger|a period of intense burnout a few years ago}, when I realized the only moments I felt genuinely clear-headed were during and after a run. Everything else. the noise, the stress, the compulsive overthinking. seemed to dissolve on the road. Since then, running has become the anchor of my mental health practice, not my fitness routine. The physical gains are real, but {insight|what gets me out there every morning is the cognitive clarity and emotional steadiness I simply can't replicate any other way}.",
      p: ["one of the few activities that clears my head completely", "the only moments I felt genuinely clear-headed were during a run", "cognitive clarity and emotional steadiness I can't replicate any other way"],
    },
  },
  {
  ...
  },
  {
    ...
    ih: {
      ...
      p: ["wonderfully unpressured. no reservations, no dress code", "conversations tend to go somewhere more real and open", "a simple format that somehow creates the conditions for genuinely good time"],
    },
    al: {
  ...
  // ─────────────────────────────────────────────
  {
    ...
    al: {
      t: "Technology is so embedded in how I live and work that I've largely stopped noticing it. which is itself something worth reflecting on carefully. It shapes {domain1|how I communicate, think, and make decisions at work} and {domain2|how I navigate cities, manage my health, and maintain relationships}. What occupies me most right now is the trajectory of AI. I have genuinely mixed feelings. The potential is {positive|extraordinary. accelerating research, democratizing access to knowledge, reducing drudgery at scale}. But so are the risks. {concern|the erosion of data privacy at a scale most people have no real framework for understanding, and a widening digital divide that means the benefits of these technologies are not reaching everyone equally}. What troubles me most is {nature|that we keep framing these as technical problems when they are fundamentally political and ethical questions}. about who decides, who benefits, and who bears the costs. That framing matters enormously, and I don't think we're getting it right yet.",
      p: ["I've largely stopped noticing technology. which is worth reflecting on", "data privacy erosion and a digital divide that leaves many behind", "framing political questions as technical ones. and getting it wrong"],
    },
  },
  {
  ...
  },
  {
    ...
    ih: {
      ...
      p: ["augment most professional work rather than simply replace it", "what humans will continue to bring that AI cannot", "excited by the possibilities and honest about how disruptive the transition is going to be for many people"],
    },
    al: {
      t: "AI raises questions I believe our society is genuinely not prepared to answer well. The upside is real. {positive|the potential to accelerate research, democratize expertise, and eliminate the most tedious parts of knowledge work is significant}. But so are the risks. {concern|a small number of organizations accumulating unprecedented concentrations of power, privacy erosion at scale, and labor market disruptions arriving faster than any institution can meaningfully adapt to}. What concerns me most is {nature|that we keep framing these as technical problems when they are fundamentally political ones}. about who benefits, who decides, and who pays the costs. I use AI in my own work and find real value in it. But I also try to {balance|maintain critical distance and not outsource judgment that should stay human}. What I keep coming back to is this: the real question isn't what AI can do, but {value|what kind of society we want to be, and whether we're making these choices deliberately enough to deserve the answer we end up with}.",
      p: ["framing political problems as technical ones", "who benefits, who decides, who pays the costs", "what kind of society we want to be. and whether we're making these choices deliberately enough"],
    },
  },
  {
